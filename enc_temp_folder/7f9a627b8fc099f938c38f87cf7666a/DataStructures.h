...
struct Position {
	...
	Position& moveForward() {
		if (facing.north) this->x += 1 / (float)randomInt(0, 5) + TILESIZE * 2;
		else if (facing.south) this->x -= 1 / (float)randomInt(0, 5) + TILESIZE * 2;
		else if (facing.east) this->z += 1 / (float)randomInt(0, 5) + TILESIZE * 2;
		else if (facing.west) this->z -= 1 / (float)randomInt(0, 5) +  TILESIZE * 2;
		return *this;
	}
	...
	Position& moveLeft() {
		if (facing.north) this->z -= 1 / (float)randomInt(0, 5) + TILESIZE * 2;
		else if (facing.south) this->z += 1 / (float)randomInt(0, 5) + TILESIZE * 2;
		else if (facing.east) this->x += 1 / (float)randomInt(0, 5) + TILESIZE * 2;
		else if (facing.west) this->x -= 1 / (float)randomInt(0, 5) + TILESIZE * 2;
		return *this;
	}
