...
void enemyPathing() {
	...
	for (auto& item : enemyCollection) {
		...
		if (bulletMap.count(id) != 0) {
			...
			// left bound
			if (bulletMap.at(id).getRawCoords().x >= item.second.getRawCoords().x - 2
				&&
				bulletMap.at(id).getRawCoords().x <= item.second.getRawCoords().x + 2
				&&
				bulletMap.at(id).getRawCoords().z >= item.second.getRawCoords().z - 2
				&&
				bulletMap.at(id).getRawCoords().z <= item.second.getRawCoords().z + 2
				&&
