...
void initTextures() {
	...
	GLuint yourmom = SOIL_load_OGL_texture("assets/textures/splash0.bmp", SOIL_LOAD_RGBA, SOIL_CREATE_NEW_ID, SOIL_FLAG_NTSC_SAFE_RGB);
...
void enemyModel(ShibaObject a) {
	...
	glPushMatrix();
		...
		float res = (float) animateTex(Enemy, 1000, true);
		std::cout << res/1000.0 << std::endl;
