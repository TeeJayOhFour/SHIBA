...
void initTextures() {
	...
	image = SOIL_load_OGL_texture("assets/textures/egg0.png", SOIL_LOAD_RGBA, SOIL_CREATE_NEW_ID, SOIL_FLAG_NTSC_SAFE_RGB);
	textureCollection.insert_or_assign(Objective, image);

	image = SOIL_load_OGL_texture("assets/textures/egg1.png", SOIL_LOAD_RGBA, SOIL_CREATE_NEW_ID, SOIL_FLAG_NTSC_SAFE_RGB);
