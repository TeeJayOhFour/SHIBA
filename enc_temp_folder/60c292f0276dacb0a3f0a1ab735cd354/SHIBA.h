...
void enemyPathing(int spawnerID);
...
void enemyPathing(int spawnerID = -1) {

	//	Spawn new enemies if needed.
	if (levelSpawning && spawnerID != -1) {
		
		//	For now rendering a white plane as enemy. Apply texture over it later.
		glColor3f(1,1,1);
		glBegin(GL_QUADS);
			glVertex3f(5, GROUNDLEVEL, 5);
			glVertex3f(5, GROUNDLEVEL, 5+2);
			glVertex3f(5, GROUNDLEVEL+5, 5+2);
			glVertex3f(5, GROUNDLEVEL+5, 5);
		glEnd();
