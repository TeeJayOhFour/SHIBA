...
public:
	...
	void render(int x, int y, int padding, int textHeight, Position* cursor) {
		...
		case SLIDER_BUTTON:
			...
			// Adding some spacing after the text and checking for hover on the slider itself
			glVertex2f(x - padding, y-padding - textHeight);
			glVertex2f(x + 50.0f, y-padding + textHeight);
			glVertex2f(x + 50.0f, y + textHeight);
			glVertex2f(x - padding, y + textHeight);
