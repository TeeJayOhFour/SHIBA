...
void enemyPathing() {
	...
	if (levelSpawning) {
		...
		int ePos = 50, eH = 10;
		glRotatef(-cameraPosition.yaw, cameraPosition.x, 1.0, cameraPosition.z);    //Along Y axis

		glBegin(GL_QUADS);
			glVertex3f(ePos, GROUNDLEVEL, ePos);
			glVertex3f(ePos, GROUNDLEVEL, ePos + 5);
			glVertex3f(ePos, GROUNDLEVEL + eH, ePos + 5);
			glVertex3f(ePos, GROUNDLEVEL + eH, ePos);
		glEnd();
