...
public:
	...
	void render(int x, int y, int padding, int textHeight) {
		...
		case TOGGLE_BUTTON:
			...
			glVertex2f(x - padding, y - padding);
			glVertex2f(x + (text.length() * 13) + gap, y - padding);
			glVertex2f(x + (text.length() * 13) + gap, y + textHeight);
			glVertex2f(x - padding, y + textHeight);
			...
			glVertex2f(x + (text.length() * 13) + gap, y - padding);
			glVertex2f(x + (text.length() * 13) + gap + 50, y - padding);
			glVertex2f(x + (text.length() * 13) + gap + 50, y + textHeight);
			glVertex2f(x + (text.length() * 13) + gap, y + textHeight);
