...
void enemyPathing() {
	...
	for (auto& item : enemyCollection) {
		...
		if (bulletMap.count(id) != 0) {
			...
			if (bulletMap.at(id).getRawCoords().x >= item.second.getRawCoords().x - 5
				&&
				bulletMap.at(id).getRawCoords().x <= item.second.getRawCoords().x + 5
				&&
				bulletMap.at(id).getRawCoords().z >= item.second.getRawCoords().z - 5
				&&
				bulletMap.at(id).getRawCoords().z <= item.second.getRawCoords().z + 5
				&&
				bulletMap.at(id).getRawCoords().y <= item.second.getRawCoords().y + 10
				&&
